...
FIELD_MATCH_BOOST = float(os.getenv("FIELD_MATCH_BOOST", ".05"))
...
FAVOR_FIELD_BOOST = float(os.getenv("FAVOR_FIELD_BOOST", "0.5"))
TITLE_MATCH_BOOST = float(os.getenv("TITLE_MATCH_BOOST", "0.07"))
